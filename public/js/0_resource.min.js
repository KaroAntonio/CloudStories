...
var o=""
n&r&&(o+="<div class='large_tip_title'>"+s.title+"</div>"),n&!r&&(o+="<div class='tip_title'>"+s.title+"</div>"),o+=r?"<div class='large_tip_content'>"+s.content+"</div>":"<div class='tip_content'>"+s.content+"</div>",$(t)[0].innerHTML=o}}function getTipKey(e,t){return Object.keys(e)[t]}function showBannerTip(e){showTip(getTipKey(intro_library,e),"#banner_tips",0!=e,!0,intro_library),$("#banner_nav")[0].innerHTML="",$("#banner_nav")[0].innerHTML+="<div id='tip_nav_left' class='nav_button' onclick='showBannerTip("+(e-1)+")'><-</div>",$("#banner_nav")[0].innerHTML+="<div id='start_button' class='nav_button'>START</div>",$("#banner_nav")[0].innerHTML+="<div id='tip_nav_right' class='nav_button' onclick='showBannerTip("+(e+1)+")'>-></div>",0==e&&($("#tip_nav_left")[0].style.visibility="hidden"),void 0==getTipKey(intro_library,e+1)?$("#tip_nav_right")[0].style.visibility="hidden":$("#start_button")[0].style.visibility="hidden",$("#close_tips").on("click",hideBannerTip),$("#start_button").on("click",hideBannerTip),$("#disable_tips").remove()}function hideBannerTip(){$("#veil").css("display","none")}function set_cookie(e,t,n,r){var i=r?"; domain="+r:""
...
var u
for(0>e.milliseconds?(u=b(-e.milliseconds/1e3),e.seconds-=u,e.milliseconds+=1e3*u):1e3<=e.milliseconds&&(e.seconds+=v(e.milliseconds/1e3),e.milliseconds%=1e3),0>e.seconds?(u=b(-e.seconds/60),e.minutes-=u,e.seconds+=60*u):60<=e.seconds&&(e.minutes+=v(e.seconds/60),e.seconds%=60),0>e.minutes?(u=b(-e.minutes/60),e.hours-=u,e.minutes+=60*u):60<=e.minutes&&(e.hours+=v(e.minutes/60),e.minutes%=60),0>e.hours?(u=b(-e.hours/24),e.days-=u,e.hours+=24*u):24<=e.hours&&(e.days+=v(e.hours/24),e.hours%=24);0>e.days;)e.months--,e.days+=t(e.refMonth,1)
if(7<=e.days&&(e.weeks+=v(e.days/7),e.days%=7),0>e.months?(u=b(-e.months/12),e.years-=u,e.months+=12*u):12<=e.months&&(e.years+=v(e.months/12),e.months%=12),10<=e.years&&(e.decades+=v(e.years/10),e.years%=10,10<=e.decades&&(e.centuries+=v(e.decades/10),e.decades%=10,10<=e.centuries&&(e.millennia+=v(e.centuries/10),e.centuries%=10))),r=0,!(1024&s)||r>=a?(e.centuries+=10*e.millennia,delete e.millennia):e.millennia&&r++,!(512&s)||r>=a?(e.decades+=10*e.centuries,delete e.centuries):e.centuries&&r++,!(256&s)||r>=a?(e.years+=10*e.decades,delete e.decades):e.decades&&r++,!(128&s)||r>=a?(e.months+=12*e.years,delete e.years):e.years&&r++,!(64&s)||r>=a?(e.months&&(e.days+=t(e.refMonth,e.months)),delete e.months,7<=e.days&&(e.weeks+=v(e.days/7),e.days%=7)):e.months&&r++,!(32&s)||r>=a?(e.days+=7*e.weeks,delete e.weeks):e.weeks&&r++,!(16&s)||r>=a?(e.hours+=24*e.days,delete e.days):e.days&&r++,!(8&s)||r>=a?(e.minutes+=60*e.hours,delete e.hours):e.hours&&r++,!(4&s)||r>=a?(e.seconds+=60*e.minutes,delete e.minutes):e.minutes&&r++,!(2&s)||r>=a?(e.milliseconds+=1e3*e.seconds,delete e.seconds):e.seconds&&r++,!(1&s)||r>=a){var d=o(e,0,"milliseconds","seconds",1e3,l)
...
var g=l.setFormat=function(e){if(e){if("singular"in e||"plural"in e){var t=e.singular||[]
t.split&&(t=t.split("|"))
var n=e.plural||[]
n.split&&(n=n.split("|"))
...
return l.setLabels=function(e,t,n,r,i,s,o){g({singular:e,plural:t,last:n,delim:r,empty:i,formatNumber:s,formatter:o})},l.resetLabels=w,w(),e&&e.exports?e.exports=l:"function"==typeof window.define&&"undefined"!=typeof window.define.amd&&window.define("countdown",[],function(){return l}),l}(module)
