...
branches.unshift(i[r].splice(o,1)[0])}branches.length>0?selected=branches[branches.length-1]:selected=null,branches.sort(function(e,t){return parseFloat(t.visits)-parseFloat(e.visits)})
var s=backColor
